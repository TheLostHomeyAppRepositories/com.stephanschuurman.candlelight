...
module.exports = class AnnaTenButtonDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('anna-10-button_on')
    ...
    this.homey.flow.getActionCard('anna-10-button_off')
      .registerRunListener(async (args) => {
        const { device } = args;
    ...
    this.homey.flow.getActionCard('anna-10-button_dim')
      .registerRunListener(async (args) => {
