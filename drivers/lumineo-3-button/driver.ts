...
module.exports = class LumineoThreeButtonDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('lumineo-3-button_on')
    ...
    this.homey.flow.getActionCard('lumineo-3-button_off')
      .registerRunListener(async (args) => {
        const { device } = args;
    ...
    this.homey.flow.getActionCard('lumineo-3-button_timer')
      .registerRunListener(async (args) => {
