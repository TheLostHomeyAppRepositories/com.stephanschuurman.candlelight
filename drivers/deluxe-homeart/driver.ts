...
module.exports = class DeluxeHomeartDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('deluxe-homeart_on')
    ...
    this.homey.flow.getActionCard('deluxe-homeart_off')
      .registerRunListener(async (args) => {
        const { device } = args;
    ...
    this.homey.flow.getActionCard('deluxe-homeart_timer')
      .registerRunListener(async (args) => {
